...
namespace MyProject.Application.Features.Common.Commands.CreateRange
{
        ...
        where TRequest : CreateRangeCommand<TCommand, TResponse>
    {
        ...
        public CreateRangeCommandHandler(IMyProjectDbContext dbContext, IMapper mapper) : base(dbContext, mapper) { }
